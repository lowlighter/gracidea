...
const main = await fetch("https://raw.githubusercontent.com/lowlighter/gracidea/main/server/data/maps/overworld.gracidea.json").then(res => res.json()) as ExportedMapData
const head = JSON.parse(await Deno.readTextFile("server/data/maps/overworld.gracidea.json")) as ExportedMapData
...
await Deno.writeTextFile("server/data/maps/overworld.gracidea.diff.json", JSON.stringify(head))
